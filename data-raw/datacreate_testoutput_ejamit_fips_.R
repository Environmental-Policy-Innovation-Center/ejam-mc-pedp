...
# if (resaving_ejam2excel) {
  fname <- paste0("testoutput_ejam2excel_fips_cities" )
  junk <- ejam2excel(
     (testoutput_ejamit_fips_cities),
    in.analysis_title = "Example of outputs of ejamit(fips= ) being formatted and saved using ejam2excel()",
...
# if (resaving_ejam2report ) {
  fname <- paste0("testoutput_ejam2report_fips_cities")
