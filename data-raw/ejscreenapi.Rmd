...
# THIS ARTICLE IN PARTICULAR IS OBSOLETE / KEPT FOR NOTES/JUST IN CASE - THE API WENT DOWN AND relevant MODULES are NO LONGER LOADED BY THIS PKG
  ...
  shiny::fluidPage(
    tabsetPanel(
      tabPanel(
        ...
        mod_ejscreenapi_ui("TESTID", simpleradiusdefault_for_ui = 2),
        br()
      )))
}
######################### #
...
![Plot of speed (time required for analysis) as function of radius size (distance from each point)](plot-speed-vs-radius.png){width="6in"}
