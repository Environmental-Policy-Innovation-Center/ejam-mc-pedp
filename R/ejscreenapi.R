...
ejscreenapi <- function(lon, lat, radius = 3, unit = 'miles', wkid = 4326 ,
  ...
  #   but old ejscreen app or app_server_EJAMejscreenapi.R code used  url_ejscreenapi_clusters_and_sort_cols( )
  #   and  ejscreenapi_plus() does too :   results_table <- url_ejscreenapi_clusters_and_sort_cols(results_table) # and see  url_columns_bysite() in EJAM pkg
  ################################################################## #
