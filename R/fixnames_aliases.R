...
fixnames_aliases <- function(x, na_if_no_match = FALSE, alias_list = NULL, ignore.case = TRUE) {
  ...
  if (is.null(alias_list)) {
    ...
    alias_list <- list(
      ...
      sqkm = c('km^2', 'km2', 'kilometer2','kilometers2', 'sq kilometers', 'sq kilometer','sqkilometers', 'sqkilometer',  'squarekilometers', 'squarekilometer', 'square kilometers', 'square kilometer'),
      sqm = c('m^2', 'm2', 'meter2','meters2', 'sq meters', 'sq meter','sqmeters', 'sqmeter',  'squaremeters', 'squaremeter', 'square meters', 'square meter'),
      sqcm = c('cm^2', 'cm2'),
      sqmm = c('mm^2', 'mm2'),
      ...
      sqmi = c('mi^2', 'mi2', 'mile2','miles2', 'sq miles', 'sq mile','sqmiles', 'sqmile',  'squaremiles', 'squaremile', 'square miles', 'square mile'),
      sqyd = c('yd^2', 'yd2'),
      sqft = c('ft^2', 'ft2'),
      sqin = c('in^2', 'in2'),
