...
popup_from_ejscreen <- function(out,
  ...
  colstofix <- c(
    ...
    names_ej_pctile_pop, names_ej_state_pctile_pop # includes  supplementary summary indexes too
  )
  if (verbose) {
  ...
  make.popup.d.api <- function(d,
    ...
    # function to MAKE THE POPUP TEXT FOR JUST THE DEMOG. INDICATORS ####
  ...
  make.popup.ej.api <- function(pctile, state.pctile, labels) {
    ...
    # function to MAKE THE POPUP TEXT FOR JUST SUMMARY INDEXES
