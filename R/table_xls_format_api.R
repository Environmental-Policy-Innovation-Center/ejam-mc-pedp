...
#'
#' @details See newer EJAM code related to this -- ejam2excel() and table_xls_format() etc.
#'
...
table_xls_format_api <- function(df, hyperlink_cols=NULL,
  ...
  #
  # NEED TO MERGE THIS WITH OTHER EJAM functions or just remove it if not needed
  #
  ########################################################  #
