...
It may be easiest to clone the repo and build/install from source (see below).

Otherwise, trying to install using remotes or devtools packages may require setting up a PAT for authentication to work:
...
# see # https://usethis.r-lib.org/articles/git-credentials.html#git-credential-helpers-and-the-credential-store
