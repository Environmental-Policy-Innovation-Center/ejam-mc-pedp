...
"The ACS data are the basis for block group resolution estimates of demographic and other data on residential populations and households."
)`

Census `r desc::desc_get("VersionCensus")` block population counts are used for the approximate distribution of residents within a given block group.
