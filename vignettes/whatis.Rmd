...
- [EJAM can be used as a web app](webapp.html), providing a simple user interface that lets anyone quickly see the results of a basic analysis. EJAM is what powered the EJScreen Multisite Tool web application.
