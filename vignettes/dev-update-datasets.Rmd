...
-   [Updating documentation](dev-update-documentation.html) - updates may be needed for the README, vignettes, and possibly examples in some functions in case updates to datasets alter how the examples would work.
